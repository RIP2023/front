...
const EditPage: FC = () => {
    ...
    const getProduct = async () => {
        const response = await axios(`http://127.0.0.1:8000/classes_of_ships/${id}`, { method: "GET" })
    ...
    const sendData = async () => {
        id ?
        await axios(`http://127.0.0.1:8000/classes_of_ships/${id}/change/`, {
            method: 'PUT',
            data: values,
            headers: {
        ...
        :
        await axios(`http://127.0.0.1:8000/classes_of_ships/add/`, {
            method: 'POST',
            data: values,
            headers: {
                'content-type': 'multipart/form-data',
